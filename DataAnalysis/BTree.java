...
class BTree {
    ...
    public static BufferHotTub hotTub = new BufferHotTub(t);
    ...
    public final Node load(long position) {
        ...
        return n.diskRead(position, hotTub.createBuffer());
    }
    ...
    void insert(String x, int frequency, int url) {
        if (root.size == (2 * t) - 1) {
            ...
            s.split(root, 0, hotTub.getBuffer(root.head), hotTub.createBuffer());
            root = s;
    ...
    public static BufferHotTub getTub() {
        return hotTub;
    }
