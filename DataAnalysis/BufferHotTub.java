...
public class BufferHotTub {

    private final long[] bufferTable = new long[131072];
    private static final ByteBuffer[] hotTub = new ByteBuffer[131072];
    private static int nodeByteSize; // (2t * 8) + ((2t-1) * 49) + 20

    public BufferHotTub(int t) {
